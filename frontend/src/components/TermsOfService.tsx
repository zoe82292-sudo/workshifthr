...
export function TermsOfService() {
  return (
    <LegalLayout title="Terms of Service">
      ...
      <p>
        ShiftWorksHR is a software tool that analyzes compensation spreadsheets you
      ...
      <p>
        Access is provided to authorized users at the discretion of ShiftWorksHR
      ...
      <p>
        To the maximum extent permitted by law, ShiftWorksHR and its operator will not
