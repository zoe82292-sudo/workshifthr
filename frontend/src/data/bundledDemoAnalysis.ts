...
export function getBundledDemoAnalysis(): AnalysisResult {
  ...
  return {
    ...
    penetration_distribution: { available: false, bands: [], total_employees: 0 },
    review_queue: { available: true, items: [], total_items: 0, critical_count: 0, high_count: 0, disclaimer: "" },
    merit_budget_variance: { available: false, file_average_merit: null, projected_merit_pool: 0, payroll_base: 0, departments: [], disclaimer: "" },
    performance_merit: { available: false, flags: [], disclaimer: "" },
